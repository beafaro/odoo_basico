...
class informacion(models.Model):
    ...
    longo_en_cms = fields.Integer(string="Largo en centímetros")
    ...
    gasto_en_moeda_seleccionada_polo_usuario = fields.Monetary("Gasto en moeda seleccionada", 'moeda_id')
    ...
    def actualiza_hora_timezone_usuario(self, obxeto_rexistro):
        obxeto_rexistro.hora_timezone_usuario = self.convirte_data_hora_de_utc_a_timezone_do_usuario(obxeto_rexistro.data_hora).strftime("%H:%M:%S")
        # Convertimos a hora de UTC a hora do timezone do usuario
    ...
    def envio_email(self):
        ...
        mail_para = 'farocarrera.beatriz@gmail.com'  # o enderezo email de destino
        mail_valores = {
